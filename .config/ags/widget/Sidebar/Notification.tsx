...
export default function Notification({ notification: n, onClose }: NotificationProps) {
  return (
    <Adw.Clamp maximumSize={400} halign={Gtk.Align.CENTER}>
      <box
        widthRequest={385}
